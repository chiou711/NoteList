...
import com.cw.NoteList.config.About;
import com.cw.NoteList.config.Config;
import com.cw.NoteList.db.DB_folder;
import com.cw.NoteList.db.DB_page;
import com.cw.NoteList.drawer.Drawer;
import com.cw.NoteList.folder.Folder;
import com.cw.NoteList.folder.FolderUi;
import com.cw.NoteList.note_add.Add_note_option;
import com.cw.NoteList.operation.delete.DeleteFolders;
import com.cw.NoteList.operation.delete.DeletePages;
import com.cw.NoteList.operation.import_export.Import_webAct;
import com.cw.NoteList.page.Checked_notes_option;
import com.cw.NoteList.page.PageUi;
import com.cw.NoteList.page.Page_recycler;
import com.cw.NoteList.tabs.TabsHost;
import com.cw.NoteList.util.DeleteFileAlarmReceiver;
import com.cw.NoteList.operation.import_export.Export_toSDCardFragment;
import com.cw.NoteList.operation.import_export.Import_filesList;
import com.cw.NoteList.db.DB_drawer;
import com.cw.NoteList.define.Define;
import com.cw.NoteList.operation.mail.MailNotes;
import com.cw.NoteList.util.OnBackPressedListener;
import com.cw.NoteList.operation.mail.MailPagesFragment;
import com.cw.NoteList.util.Util;
import com.cw.NoteList.util.preferences.Pref;
...
//                StrictMode.setVmPolicy(builder.build());
    ...
    void doCreate()
    {
        ...
        if (!Util.isEmptyString(intentLink)) {
            finish(); // NoteList not running at first, keep closing
            return;
        } else {
            // check DB
    ...
    // if one NoteList Intent is already running, call it again in YouTube or Browser will run into this
    @Override
