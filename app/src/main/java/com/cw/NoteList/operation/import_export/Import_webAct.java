...
package com.cw.NoteList.operation.import_export;
...
public class Import_webAct extends AppCompatActivity
{
    ...
    String homeUrl = "https://notelistapp.blogspot.com/2017/09/xml-link.html";
    String downloadUrl ;

    // issue:
    //     java.lang.RuntimeException:
    //     Unable to start activity ComponentInfo{com.cw.notelist/com.cw.notelist.operation.import_export.Import_webAct}:
    ...
    void doCreate()
    {
        ...
        // show toast
        webView.addJavascriptInterface(import_interface, "NoteList");
